...
Since version 0.10.0 Vault supports kv secrets versioning so-called [KV version 2](https://www.vaultproject.io/api/secret/kv/kv-v2.html). By default version 1 support is enabled. To configure module to work with version 2 secrets specify the *:kv_version* setting e.g.
